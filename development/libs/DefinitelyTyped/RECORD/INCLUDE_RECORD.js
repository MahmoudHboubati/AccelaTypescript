...
var currentUserID;
var logDebug;
var asiTableValObj = (function () {
    function asiTableValObj(newAsitFieldName, fieldValue, N) {
    }
    return asiTableValObj;
}());
var s_capResult;
var capModel;
function Record(id) {
...
Record.prototype.asitToArray = function (asit) {
    ...
    while (tsmfldi.hasNext()) {
        var row = {};
        for (var i = 0; i < tsmcoli.size() && tsmfldi.hasNext(); i++) {
